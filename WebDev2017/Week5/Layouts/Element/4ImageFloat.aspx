<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="4ImageFloat.aspx.cs" Inherits="WebDev2016.Week5.Layouts.Element._4ImageFloat" %>

<asp:Content ID="Content1" ContentPlaceHolderID="CPHead" runat="server">
    <style>
        #demo .border {
            border: 1px solid #c00;
            box-sizing: border-box; /* include padding and border in total width calculations */
        }

            #demo span, #demo .border:not(img.border) {
                margin-bottom: 50px;
            }
    </style>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="CPMain" runat="server">
    <div class="jumbotron">
        <h2 class="text-center">Floating elements allows others to wrap around!</h2>
    </div>
    <div class="row" id="demo">
        <div class="col-md-8 col-md-offset-2">

            <img class="border" style="float: left" src="/Images/KermitHappy.jpg" />
            <p class="border">Robert Stadler paced his office, wishing he would not feel the cold. Spring had been late in coming. Beyond the window, the dead gray of the hills looked like the smeared transition from the soiled white of the sky to the leaden black of the river. Once in a while, a distant patch of hillside flared into a silver-yellow that was almost green, then vanished. The clouds kept cracking for the width of a single sunray, then oozing closed again. It was not cold in the office, thought Dr. Stadler, it was that view that froze the place.</p>
            <p class="border">
